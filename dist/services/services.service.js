...
let ServicesService = class ServicesService {
    ...
    async updateStatus(serviceId, isDisabled) {
        const updated = await this.serviceModel.findByIdAndUpdate(new mongoose_2.Types.ObjectId(serviceId), { isDisabled }, { new: true });
        if (!updated) {
            throw new common_1.NotFoundException(this.i18n.translate("auth.services.service_not_found", {
                lang: this.lang,
            }));
