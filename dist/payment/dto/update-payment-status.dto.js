...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'txn_abc123' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdatePaymentStatusDto.prototype, "transactionId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['success', 'failed', 'cancelled'], example: 'success' }),
    (0, class_validator_1.IsIn)(['success', 'failed', 'cancelled']),
    __metadata("design:type", String)
