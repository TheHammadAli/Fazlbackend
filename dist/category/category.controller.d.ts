...
export declare class CategoryController {
    ...
    create(dto: CreateUpdateCategoryDto, icon?: any): Promise<import("mongoose").Document<unknown, {}, import("./schema/category.schema").CategoryDocument, {}> & import("./schema/category.schema").Category & import("mongoose").Document<unknown, any, any, Record<string, any>> & Required<{
        _id: unknown;
    }> & {
        __v: number;
    }>;
    findAll(type?: string): Promise<{
        data: {
            ...
            $assertPopulated: <Paths = {}>(path: string | string[], values?: Partial<Paths> | undefined) => Omit<import("./schema/category.schema").CategoryDocument, keyof Paths> & Paths;
            $clearModifiedPaths: () => import("./schema/category.schema").CategoryDocument;
            $clone: () => import("./schema/category.schema").CategoryDocument;
            ...
            $inc: (path: string | string[], val?: number) => import("./schema/category.schema").CategoryDocument;
            ...
            $restoreModifiedPathsSnapshot: (snapshot: import("mongoose").ModifiedPathsSnapshot) => import("./schema/category.schema").CategoryDocument;
            $session: (session?: import("mongoose").ClientSession | null) => import("mongoose").ClientSession | null;
            $set: {
                (path: string | Record<string, any>, val: any, type: any, options?: import("mongoose").DocumentSetOptions): import("./schema/category.schema").CategoryDocument;
                (path: string | Record<string, any>, val: any, options?: import("mongoose").DocumentSetOptions): import("./schema/category.schema").CategoryDocument;
                (value: string | Record<string, any>): import("./schema/category.schema").CategoryDocument;
            };
            ...
            depopulate: <Paths = {}>(path?: string | string[]) => import("mongoose").MergeType<import("./schema/category.schema").CategoryDocument, Paths>;
            ...
            getChanges: () => import("mongoose").UpdateQuery<import("./schema/category.schema").CategoryDocument>;
            id?: any;
            increment: () => import("./schema/category.schema").CategoryDocument;
            init: (obj: import("mongoose").AnyObject, opts?: import("mongoose").AnyObject) => import("./schema/category.schema").CategoryDocument;
            invalidate: {
            ...
            overwrite: (obj: import("mongoose").AnyObject) => import("./schema/category.schema").CategoryDocument;
            $parent: () => import("mongoose").Document | undefined;
            populate: {
                <Paths = {}>(path: string | import("mongoose").PopulateOptions | (string | import("mongoose").PopulateOptions)[]): Promise<import("mongoose").MergeType<import("./schema/category.schema").CategoryDocument, Paths>>;
                <Paths = {}>(path: string, select?: string | import("mongoose").AnyObject, model?: import("mongoose").Model<any>, match?: import("mongoose").AnyObject, options?: import("mongoose").PopulateOptions): Promise<import("mongoose").MergeType<import("./schema/category.schema").CategoryDocument, Paths>>;
            };
            populated: (path: string) => any;
            replaceOne: (replacement?: import("mongoose").AnyObject, options?: import("mongoose").QueryOptions | null) => import("mongoose").Query<any, import("./schema/category.schema").CategoryDocument, {}, unknown, "find", Record<string, never>>;
            save: (options?: import("mongoose").SaveOptions) => Promise<import("./schema/category.schema").CategoryDocument>;
            ...
            set: {
                <T extends string | number | symbol>(path: T, val: any, type: any, options?: import("mongoose").DocumentSetOptions): import("./schema/category.schema").CategoryDocument;
                (path: string | Record<string, any>, val: any, type: any, options?: import("mongoose").DocumentSetOptions): import("./schema/category.schema").CategoryDocument;
                (path: string | Record<string, any>, val: any, options?: import("mongoose").DocumentSetOptions): import("./schema/category.schema").CategoryDocument;
                (value: string | Record<string, any>): import("./schema/category.schema").CategoryDocument;
            };
            ...
            updateOne: (update?: import("mongoose").UpdateWithAggregationPipeline | import("mongoose").UpdateQuery<import("./schema/category.schema").CategoryDocument> | undefined, options?: import("mongoose").QueryOptions | null) => import("mongoose").Query<any, import("./schema/category.schema").CategoryDocument, {}, unknown, "find", Record<string, never>>;
            validate: {
